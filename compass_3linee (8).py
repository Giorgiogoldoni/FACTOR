...
def main():
    ...
    # ── 1. Proxy ──────────────────────────────────────────────────────
    print(f"\n[1/5] Download {len(ETF_PROXY)} ETF proxy...")
    proxy_data = {}
    for t in ETF_PROXY:
    ...
    print(f"\n[2/5] Download {len(tutti_ticker)} ETF universo...")
    etf_data = {}
    success = 0; errors = 0
    ...
    # ── 3. Backtest ───────────────────────────────────────────────────
    print(f"\n[3/5] Backtest 3 linee (da {BACKTEST_START})...")
    portafogli = {}
    FORCE_RESET = {"O"}
    ...
    # ── 5. Fase 2 ─────────────────────────────────────────────────────
    print(f"\n[5/5] Fase 2 — Rotation capitale tra le 3 linee...")
